...
export const metadata: Metadata = {
  title: "Estonia - Discover the Digital Nation of the Baltics",
  description: "Explore Estonia's perfect blend of medieval heritage and digital innovation. Plan your visit to Tallinn, discover cultural treasures, and experience the world's first digital society.",
  keywords: "Estonia, Tallinn, Baltic states, digital nation, medieval heritage, travel Estonia, visit Estonia, e-residency",
  metadataBase: new URL("https://discoverestonia.com"),
  alternates: {
    canonical: "https://discoverestonia.com"
  },
  openGraph: {
    title: "Estonia - Discover the Digital Nation of the Baltics",
    description: "Explore Estonia's perfect blend of medieval heritage and digital innovation. Plan your visit to discover cultural treasures and cutting-edge technology.",
    url: "https://discoverestonia.com",
    siteName: "Discover Estonia",
    images: [{
      url: "https://images.pexels.com/photos/5534598/pexels-photo-5534598.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Tallinn Old Town medieval architecture"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Estonia - Medieval Heritage Meets Digital Innovation",
    description: "Discover Estonia's unique blend of history and technology. Plan your Baltic adventure today.",
    images: ["https://images.pexels.com/photos/5534598/pexels-photo-5534598.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
